...
var _user$project$Base_Navbar$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {
			ctor: '_Tuple2',
...
var _user$project$Base_Navbar$Model = function (a) {
	return {navbarState: a};
};
var _user$project$Base_Navbar$NavbarMsg = function (a) {
	return {ctor: 'NavbarMsg', _0: a};
};
var _user$project$Base_Navbar$initState = function () {
	var _p1 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_user$project$Base_Navbar$NavbarMsg);
	var navbarState = _p1._0;
	var navbarCmd = _p1._1;
	return {
		ctor: '_Tuple2',
		_0: {navbarState: navbarState},
		_1: navbarCmd
	};
}();
var _user$project$Base_Navbar$subscriptions = function (model) {
	return A2(_rundis$elm_bootstrap$Bootstrap_Navbar$subscriptions, model.navbarState, _user$project$Base_Navbar$NavbarMsg);
};
var _user$project$Base_Navbar$view = function (model) {
	return A2(
		...
		A2(
			_rundis$elm_bootstrap$Bootstrap_Navbar$items,
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Visualize'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Tweet Dat(a) Hate'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				},
				_rundis$elm_bootstrap$Bootstrap_Navbar$collapseLarge(
					_rundis$elm_bootstrap$Bootstrap_Navbar$fixTop(
						_rundis$elm_bootstrap$Bootstrap_Navbar$config(_user$project$Base_Navbar$NavbarMsg))))));
};
var _user$project$Base_Navbar$main = _elm_lang$html$Html$program(
	{view: _user$project$Base_Navbar$view, update: _user$project$Base_Navbar$update, subscriptions: _user$project$Base_Navbar$subscriptions, init: _user$project$Base_Navbar$initState})();

var Elm = {};
Elm['Base'] = Elm['Base'] || {};
Elm['Base']['Navbar'] = Elm['Base']['Navbar'] || {};
if (typeof _user$project$Base_Navbar$main !== 'undefined') {
    _user$project$Base_Navbar$main(Elm['Base']['Navbar'], 'Base.Navbar', undefined);
}
